...
export default function CheckoutSimpleWorking() {
  ...
  // Initialize Stripe when clientSecret is ready
  useEffect(() => {
    ...
    const initializeStripe = () => {
      try {
        const stripeInstance = (window as any).Stripe(import.meta.env.VITE_STRIPE_PUBLIC_KEY);
      ...
      if (paymentIntent?.status === 'succeeded') {
        try {
          ...
          toast({
            ...
            description: "Thank you! Your PDF report is now available.",
          });
