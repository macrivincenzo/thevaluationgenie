...
function CheckoutForm({ valuationId, valuation }: { valuationId: string, valuation: any }) {
...
export default function CheckoutWorkingFinal() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Elements stripe={stripePromise} options={elementsOptions}>
        <CheckoutForm valuationId={valuationId!} valuation={valuation} />
      </Elements>
    </div>
  );
}